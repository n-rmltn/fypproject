...
<div class="w-100">
    ...
    >
        ...
        <li class="nav-item dropdown dropdown position-static">
            ...
            href="<?php echo e(route('product.show','keyboard')); ?>"
            role="button"
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('product.show','mouse')); ?>" role="button">
            Mouse
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('product.show','headphone')); ?>" role="button"> Headphone </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('product.show','monitor')); ?>" role="button"> Monitor </a>
        </li>
        </ul>
        <!-- / Menu-->
    </div>
