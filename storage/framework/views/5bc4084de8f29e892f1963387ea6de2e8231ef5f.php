...
<div class="w-100">
    ...
    >
        ...
        <li class="nav-item dropdown dropdown position-static">
            ...
            href="<?php echo e(route('product.index',['category' => 'keyboard'])); ?>"
            role="button"
                ...
                <div class="col col-lg-8 py-lg-5">
                    ...
                    <div class="col">
                        ...
                        <li class="dropdown-list-item">
                            <a class="dropdown-item" href="<?php echo e(route('product.show','keyboard')); ?>"
                            >Full-size</a
                            >
                        </li>
                        <li class="dropdown-list-item">
                    ...
                    <div class="row g-4">
                        ...
                        >
                            ...
                            <img
                                class="w-100 rounded"
                                title=""
                                src="<?php echo e(asset('assets/images/banners/banner-8.jpg')); ?>"
                                alt=" "
                            />
                            </picture>
                        ...
                        >
                            ...
                            <img
                                class="w-100 rounded"
                                title=""
                                src="<?php echo e(asset('assets/images/banners/banner-9.jpg')); ?>"
                                alt=" "
                            />
                            </picture>
                            <a class="fw-bolder link-cover" href="#"
                        ...
                        >
                            ...
                            <img
                                class="w-100 rounded"
                                title=""
                                src="<?php echo e(asset('assets/images/banners/banner-10.jpg')); ?>"
                                alt=" "
                            />
                            </picture>
                            <a class="fw-bolder link-cover" href="#"
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('product.index',['category' => 'mouse'])); ?>" role="button">
            Mouse
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('product.index',['category' => 'headphone'])); ?>" role="button"> Headphone </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('product.index',['category' => 'monitor'])); ?>" role="button"> Monitor </a>
        </li>
        </ul>
        <!-- / Menu-->
    </div>
...
<!-- / Navbar-->
<?php /**PATH C:\inetpub\laravel-kbdmy\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>