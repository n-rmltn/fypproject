...
<section class="mt-0 overflow-hidden">
    ...
    <div class="position-relative row my-lg-7 pt-5 pt-lg-0 g-8">
        ...
        <a href="<?php echo e(route('product.index')); ?>" class="btn btn-psuedo text-white" role="button"
            >Shop All Product</a
        >
        </div>
        <div
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\laravel-kbdmy\resources\views/index.blade.php ENDPATH**/ ?>