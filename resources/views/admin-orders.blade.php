        ...
        <div
            ...
            <nav class="mb-0" aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin-orders') }}">Orders
                    </li>
                </ol>
            </nav>
        </div>
                ...
                <div class="card mb-4 h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <form
                                class="bg-light rounded px-3 py-1 flex-shrink-0 d-flex align-items-center visually-hidden">
                                                                                ...
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown" aria-labelledby="dropdownOrder-0">
                                                                                        <li><a class="dropdown-item"
                                                                                                href="{{ route('admin-orders-details', $val->id) }}">View
                                                                                                details</a></li>
