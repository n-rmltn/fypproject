        ...
        <div class="container-fluid">
            <nav class="m-0" aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item breadcrumb-light">
                        <a
                            href="{{ route('product.index', ['category' => $product->product_categories]) }}">{{ $product->product_categories }}</a>
                    </li>
    ...
    <div class="container-fluid mt-5">
                        ...
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable
                                    src="{{ asset('assets/images/products/' . $images->product_images_name) }}" alt=" " />
                            </picture>
                        </div>
                    @endforeach
                </div>
                    ...
                    <div class="pb-3" data-aos="fade-in">
                        ...
                        <form action="{{ route('cart.store') }}" method="post">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="fs-4 m-0 product-base-price"
                                    data-baseprice="{{ $product->product_base_price }}">
                                    RM{{ $product->product_base_price }}</p>
                            </div>
                                ...
                                <div class="border-top mt-4 mb-3 product-option">
                                    <small class="text-uppercase pt-4 d-block fw-bolder">
                                        ...
                                        <span class="selected-option fw-bold"
                                            ...
                                            data-addprice="0">Not Selected</span>
                                    </small>
                                    <div class="mt-4 d-flex justify-content-start flex-wrap align-items-start">
                                        @forelse ($option->list as $list)
                                            <div class="form-check-option form-check-rounded">
                                                <input type="radio" name="product-option-{{ $option->product_option_name }}"
                                                    ...
                                                    data-option="{{ $option->product_option_name }}" required />
                                        ...
                                        <ul class="list-group list-group-flush">
                                            @foreach ($product->details as $details)
                                                <li class="list-group-item d-flex border-0 row g-0 px-0">
                                                    <span
                                                        class="col-4 fw-bolder">{{ $details->product_details_header }}</span>
                                                    <span
                                                        class="col-7 offset-1">{{ $details->product_details_content }}</span>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    ...
                                    <div class="accordion-body">
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item d-flex border-0 row g-0 px-0">
                                                ...
                                                <span class="col-7 offset-1">30 day return period. See our
                                                    <a class="text-link-border" href="#">terms & conditions.</a></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-12" data-aos="fade-up">
                ...
                "breakpoints": {
                  "600": {
                    "slidesPerView": @if (count($suggestions) < 2)
                        {{ count($suggestions) }}
                    @else
                        2
                    @endif
                  ...
                  "1024": {
                    "slidesPerView": @if (count($suggestions) < 3)
                        {{ count($suggestions) }}
                    @else
                        3
                    @endif
                  ...
                  "1400": {
                    "slidesPerView": @if (count($suggestions) < 4)
                        {{ count($suggestions) }}
                    @else
                        4
                    @endif
                    ...
                    <div class="swiper-wrapper">
                        @forelse ($suggestions as $suggestion => $suggest)
                                ...
                                <div
                                    ...
                                    <div class="card-img position-relative">
                                        ...
                                        <picture class="position-relative overflow-hidden d-block bg-light">
                                            <img class="w-100 img-fluid position-relative z-index-10" title=""
                                                src="{{ asset('assets/images/products/' . $suggest->product_cart_images_name) }}"
                                                alt="">
                                        </picture>
                                    ...
                                    <div class="card-body px-0">
                                        <a class="text-decoration-none link-cover"
                                            href="{{ route('product.show', $suggest->product_id) }}">{{ $suggest->product_name_short }}</a>
                                        <small class="text-muted d-block">
                                            @forelse ($suggest->option as $option => $value)
                                                {{ count($value->list) }} {{ $value->product_option_name }}
                                            @empty

                                            @endforelse</small>
                                        <p class="mt-2 mb-0 small">{{ $suggest->product_base_price }}</p>
                                    </div>
                                </div>
                                <!--/ Card Product-->
                            </div>
