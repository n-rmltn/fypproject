    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            @if ($paginator->onFirstPage())
                <span class="btn btn-outline-dark btn-sm mt-5 align-self-center py-3 px-4 border-2 ">
                    {!! __('pagination.previous') !!}
                </span>
            @else
                <a href="{{ $paginator->previousPageUrl() }}" class="btn btn-outline-dark btn-sm mt-5 align-self-center py-3 px-4 border-2">
                    {!! __('pagination.previous') !!}
                </a>
            @endif

            @if ($paginator->hasMorePages())
                <a href="{{ $paginator->nextPageUrl() }}" class="btn btn-outline-dark btn-sm mt-5 align-self-center py-3 px-4 border-2">
                    {!! __('pagination.next') !!}
                </a>
            @else
                <span class="btn btn-outline-dark btn-sm mt-5 align-self-center py-3 px-4 border-2">
