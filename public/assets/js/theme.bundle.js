!(function (e) {
    ...
    179: function (e, t, n) {
              ...
              data.forEach(function(key,val){
                console.log(key['item_price']);
                            ...
                            document.querySelector(
                                ".number-of-item"
                            ).innerText = "Cart ( " + count_item + " )";
                            document.querySelector(".number-item").innerText =
                                "Cart Summary ( " + count_item + " item )";
                        },
                    });
                }
                function r() {
        ...
        !(function () {
            ...
            (document.querySelectorAll("[data-zoomable-btn]") || []).forEach(
                (e) => {
            ...
            constructor(e) {
                (this.menuToggle = e),
                    ...
                    (this.cssVarBreakPoint =
                        ...
                        ).getPropertyValue("--theme-breakpoint-lg") || "992px"),
